...
class CancelarCompraDeProductosSeleccionados(unittest.TestCase):
    def setUp(self):
    ...
    def test_cancelar_compra_de_productos_seleccionados(self):
        driver = self.driver
        ...
        driver.find_element_by_id("postal-code").send_keys("12543")
