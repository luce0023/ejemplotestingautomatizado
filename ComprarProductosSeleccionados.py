...
class ComprarProductosSeleccionados(unittest.TestCase):
    def setUp(self):
    ...
    def test_comprar_productos_seleccionados(self):
        driver = self.driver
        driver.get("https://www.saucedemo.com/")
        driver.find_element_by_id("user-name").click()
        driver.find_element_by_id("user-name").clear()
        driver.find_element_by_id("user-name").send_keys("standard_user")
        driver.find_element_by_xpath("//div[@id='login_button_container']/div/form").click()
