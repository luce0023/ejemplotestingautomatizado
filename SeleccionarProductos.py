...
class SeleccionarProductos(unittest.TestCase):
    def setUp(self):
    ...
    def test_seleccionar_productos(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//div[@id='cart_contents_container']/div/div[2]").click()
